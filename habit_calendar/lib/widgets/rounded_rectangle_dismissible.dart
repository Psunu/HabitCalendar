...
/// Signature used by [RoundedRectangleDismissible] to indicate that it has been dismissed in
/// the given `direction`.
///
/// Used by [RoundedRectangleDismissible.onDismissed].
typedef DismissDirectionCallback = void Function(DismissDirection direction);

/// Signature used by [RoundedRectangleDismissible] to give the application an opportunity to
/// confirm or veto a dismiss gesture.
///
/// Used by [RoundedRectangleDismissible.confirmDismiss].
typedef ConfirmDismissCallback = Future<bool> Function(
    DismissDirection direction);

/// The direction in which a [RoundedRectangleDismissible] can be dismissed.
enum DismissDirection {
  /// The [RoundedRectangleDismissible] can be dismissed by dragging either up or down.
  vertical,

  /// The [RoundedRectangleDismissible] can be dismissed by dragging either left or right.
  horizontal,

  /// The [RoundedRectangleDismissible] can be dismissed by dragging in the reverse of the
  /// reading direction (e.g., from right to left in left-to-right languages).
  endToStart,

  /// The [RoundedRectangleDismissible] can be dismissed by dragging in the reading direction
  /// (e.g., from left to right in left-to-right languages).
  startToEnd,

  /// The [RoundedRectangleDismissible] can be dismissed by dragging up only.
  up,

  /// The [RoundedRectangleDismissible] can be dismissed by dragging down only.
  down
}
...
class RoundedRectangleDismissible extends StatefulWidget {
  /// Creates a widget that can be dismissed.
  ///
  /// The [key] argument must not be null because [RoundedRectangleDismissible]s are commonly
  /// used in lists and removed from the list when dismissed. Without keys, the
  /// default behavior is to sync widgets based on their index in the list,
  /// which means the item after the dismissed item would be synced with the
  /// state of the dismissed item. Using keys causes the widgets to sync
  /// according to their keys and avoids this pitfall.
  const RoundedRectangleDismissible({
    @required Key key,
    @required this.child,
    this.borderRadius,
    this.background,
  ...
  @override
  _RoundedRectangleDismissibleState createState() =>
      _RoundedRectangleDismissibleState();
}
...
class _RoundedRectangleDismissibleState
    extends State<RoundedRectangleDismissible>
